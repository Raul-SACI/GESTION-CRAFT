...
const SYSTEM_MODULES = [
  ...
  { id: 'checklist_sucursal', label: 'Check-List Operativo', category: 'Gestión Sucursal' },
  ...
  { id: 'evaluacion_duenos', label: 'Evaluación de Dueños', category: 'Gestión Líderes Operativos' },
  ...
  { id: 'pedidos_recepcion', label: 'Pedidos Internos (Recepción)', category: 'Centro de Producción' },
